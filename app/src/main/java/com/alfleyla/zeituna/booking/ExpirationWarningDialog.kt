...
class ExpirationWarningDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_expiration_warning, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val tvMessage = view.findViewById<TextView>(R.id.tvExpirationWarningMessage)
        val btnOk = view.findViewById<MaterialButton>(R.id.btnExpirationWarningOk)
